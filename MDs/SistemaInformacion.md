...
Además, los usuarios podrán almacenar en una lista de deseados los contenidos que quieren ver en un futuro. En dicha lista no habrá una calificación ni una fecha en la que se añadió el contenido.
...
Los usuarios tambíen pueden desbloquear logros dependiendo del contenido que tengan añadido en sus librerías. De estos logros queremos almacenar el nombre y el contenido que lo conforma, así como la fecha en la que se desbloqueó.
